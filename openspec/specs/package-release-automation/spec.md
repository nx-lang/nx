...
## Purpose
Define how NX package registry publication is coordinated from verified CI artifacts, including
preview/test publication, production publication, deployment environments, registry
authentication, and maintainer runbooks.
