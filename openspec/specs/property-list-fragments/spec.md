# property-list-fragments Specification

## Purpose
Define conditional and match-style property-list fragments for NX markup invocations, including
lowering, path-sensitive validation, runtime evaluation, diagnostics, documentation, and tooling.
