...
/// <summary>
/// Represents a reusable registry of analyzed NX libraries used by program build contexts.
/// </summary>
public sealed class NxLibraryRegistry : IDisposable
{
    ...
    /// Thrown when the native runtime cannot create the registry.
    /// </exception>
    ...
    /// <summary>
    /// Loads and analyzes a local NX library root into this registry for future build contexts.
    /// </summary>
    ...
    /// <exception cref="ObjectDisposedException">Thrown when this registry has already been disposed.</exception>
    ...
    /// </summary>
    /// <returns>A disposable build context that can validate workspaces and build program artifacts.</returns>
    /// <exception cref="ObjectDisposedException">Thrown when this registry has already been disposed.</exception>
    /// <exception cref="InvalidOperationException">
    /// Thrown when the native runtime cannot create the context.
    /// </exception>
