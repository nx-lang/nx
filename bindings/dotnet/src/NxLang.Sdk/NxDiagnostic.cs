...
/// <summary>
/// Represents a structured diagnostic reported by NX validation, build, IR generation, or evaluation.
/// </summary>
[MessagePackObject]
...
/// <summary>
/// Represents a source location attached to an NX diagnostic.
/// </summary>
[MessagePackObject]
public sealed class NxDiagnosticLabel
{
    /// <summary>
    /// Gets or sets the logical file or workspace identity where this diagnostic label is located.
    /// </summary>
    [Key("file")]
    ...
    /// <summary>
    /// Gets or sets an optional message specific to this label.
    /// </summary>
    [Key("message")]
    [JsonPropertyName("message")]
    ...
    /// <summary>
    /// Gets or sets a value indicating whether this is the primary label for the diagnostic.
    /// </summary>
    [Key("primary")]
