...
/// <summary>
/// Represents a registry-backed build scope used to validate workspaces and create reusable program artifacts.
/// </summary>
public sealed class NxProgramBuildContext : IDisposable
{
    ...
    /// </summary>
    /// <remarks>
    /// Program artifacts created from this context remain usable after the context is disposed. Calling
    /// <see cref="Dispose()"/> more than once is allowed.
    /// </remarks>
    public void Dispose()
    {
        _handle.Dispose();
