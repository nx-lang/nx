...
- [X] T095 [P] [US2] Implement primitive type constants (String, Int, Int32, Int64, Float32, Float64, Boolean, Void) - implemented as Primitive enum and Type::int(), Type::float64(), etc. methods in crates/nx-types/src/ty.rs
