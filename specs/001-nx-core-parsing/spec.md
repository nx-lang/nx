...
- **Type**: Representation of NX types including primitives (string, int, int32, int64, float32, float64, boolean, object), sequences (T[]), functions ((T1, T2) => T3), nullable (T?), and user-defined types
