/**
 * Runs the two halves of development together: Vite on 5173, serving the site at
 * `/playground/`, and the compile server on 5174 (or wherever `PORT` puts it — the Vite proxy reads
 * the same setting, so the two cannot drift apart).
 *
