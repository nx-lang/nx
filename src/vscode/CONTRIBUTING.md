...
- `images/icon.png` - The Marketplace and Open VSX icon: the NX app icon at 128×128, since the
  Marketplace does not accept SVG. Generated by `branding/generate.mjs`; see
